google.charts.load('current', {'packages':['corechart']});
      ...
      var tooltipData = [
        ['Cursos', 'Microscópio Eletrônico de Transmissão JEOL JEM 1200EX-II', 'Microscópio Eletrônico de Varredura JEOL JSM 6360-LV', 'Microscópio Eletrônico de Varredura TESCAN VEGA3 LMU', 'Microscópio Eletrônico de Varredura FEI Quanta 450 FEG',
        'Microscópio Raman Confocal Witec alpha 300R', 'Microscópio de Força Atômica Shimadzu SPM 9500 J3',
        ...
        ['Engenharia Mecânica', 18.2, 106.5, 19.4, 2.2, 5.2, 2.3, 1.2]
      ];
