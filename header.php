    ...
    <div class="caixa">
        ...
        <header class="">
            ...
            <div class="content">
                ...
                <img class="logo" id="logo" src="img/logo.png" alt="Logo do Centro de Microscopia Eletrônica da Universidade Federal do Paraná.">
                ...
                <nav class="menu-ufpr">
                    ...
                    <ul>
                        ...
                        <li><a href="https://www.ufpr.br/portalufpr/saci-sistema-de-apoio-a-comunicacao-integrada/">Comunicação</a>
                        </li>
                    </ul>
            ...
            <div class="barra-pesquisa">
                ...
                <form action="http://www.bio.ufpr.br/portal" id="searchform" method="get">
                    ...
                    <!--Botão de Pesquisar-->
                    <button type="submit" id="barra-pesquisa-botao"></button>
                </form>
            ...
            <nav class="menu">
                <!--Divisão do Ícone do Menu Responsivo-->
